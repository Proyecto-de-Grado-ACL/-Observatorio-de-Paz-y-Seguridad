...
---
  ...
  En términos generales, los resultados muestran que el nivel de confianza promedio en la Policía se ubica en un punto intermedio alrededor de 4.06 sobre 7, y 4.15 cuando se toma en cuenta la densidad poblacional, lo que sugiere una percepción moderada por parte de la ciudadanía. La distribución evidencia una concentración importante en valores medios (3, 4 y 5), mientras que los extremos son menos frecuentes, lo que indica que no existe una polarización fuerte sino una tendencia hacia evaluaciones neutrales o ligeramente positivas. Este comportamiento sugiere que, si bien no hay un rechazo generalizado hacia la institución, tampoco se observa un nivel alto de confianza consolidada, lo que refuerza la importancia de analizar las diferencias por grupos poblacionales para entender mejor estas variaciones.
  ...
  El análisis territorial muestra diferencias claras en los niveles de confianza en la Policía entre las regiones del país. La región Andina presenta el nivel más alto de confianza (4.45), seguida por la Orinoquía-Amazonía (4.10) y la región Pacífica (4.03), mientras que el Caribe (3.84) y Bogotá D.C. (3.81) registran los valores más bajos. Estos resultados son especialmente relevantes cuando se consideran junto con la distribución poblacional: la región Andina, además de presentar la mayor confianza, concentra la mayor proporción de la población del país, lo que influye significativamente en el promedio nacional. En contraste, aunque regiones como la Orinoquía-Amazonía presentan niveles relativamente altos de confianza, su bajo peso poblacional limita su impacto en el resultado agregado. 
  
  Asimismo, los niveles más bajos observados en Bogotá y el Caribe son críticos, ya que corresponden a zonas con alta densidad poblacional, lo que sugiere que las percepciones negativas o moderadas en estas áreas tienen un efecto importante en la percepción general del país. En conjunto, este análisis evidencia que la confianza no solo varía territorialmente, sino que su impacto en el indicador nacional depende directamente del peso demográfico de cada región. En síntesis, la confianza en la Policía en Colombia se caracteriza por ser moderada, con variaciones relevantes según el territorio y los grupos poblacionales.
...
---
  ...
  Los resultados sobre legitimidad institucional evidencian una percepción mixta del comportamiento policial. Por un lado, el 41.2% de los encuestados considera que el trato respetuoso hacia los ciudadanos ocurre con frecuencia, lo que sugiere que existe un reconocimiento relativamente alto de conductas positivas en la interacción cotidiana. Sin embargo, este resultado contrasta con el hecho de que solo el 25.2% percibe que las decisiones al usar la fuerza son justas de manera frecuente, lo que indica una menor confianza en aspectos más críticos del ejercicio de autoridad.
  ...
  En paralelo, aunque los comportamientos negativos presentan menores porcentajes como solicitudes de sobornos (12.3%), violaciones de derechos humanos (10.8%) y protección a delincuentes (15.2%), su presencia no es despreciable y refleja que una parte relevante de la población percibe prácticas problemáticas dentro de la institución. En conjunto, estos resultados muestran que la legitimidad no es uniforme: mientras las interacciones básicas pueden ser valoradas positivamente, persisten dudas importantes sobre la transparencia, el uso de la fuerza y la integridad institucional, lo que limita la consolidación de una confianza plena en la Policía.
  ...
  Los resultados evidencian un desbalance entre percepciones positivas y negativas en la legitimidad de la Policía. Mientras el trato respetuoso hacia los ciudadanos se posiciona como el indicador más fuerte, los aspectos relacionados con la justicia en el uso de la fuerza presentan niveles considerablemente más bajos, lo que sugiere una debilidad en dimensiones críticas del ejercicio de autoridad. 
  
  Por otro lado, aunque los indicadores negativos registran porcentajes menores, su presencia es consistente y no marginal, lo que indica que una parte relevante de la población percibe prácticas problemáticas. En conjunto, esto refleja que la legitimidad institucional no depende únicamente de interacciones cotidianas positivas, sino también de la confianza en procesos más sensibles, donde actualmente se evidencian mayores desafíos. En conjunto, la legitimidad institucional se percibe como parcial: existen fortalezas en el trato cotidiano, pero debilidades en aspectos críticos como el uso de la fuerza.
  ...
  Los resultados muestran que la percepción de efectividad es heterogénea tanto por región como por tipo de función. En general, el mantenimiento de la seguridad tiende a ser mejor evaluado en comparación con otras funciones, mientras que el control del tráfico de drogas presenta los niveles más bajos de percepción en todas las regiones, lo que sugiere una debilidad transversal en este ámbito. A nivel territorial, la región Andina se destaca con los valores más altos en las tres dimensiones, mientras que el Caribe y Bogotá D.C. presentan evaluaciones consistentemente más bajas. Esto indica que, al igual que en la confianza y la legitimidad, la percepción del desempeño policial no es uniforme y está influenciada por el contexto regional, evidenciando posibles brechas en la efectividad percibida de la institución.
  ...
  Los resultados muestran que las diferencias entre zonas urbanas y rurales son relativamente pequeñas en todas las variables, lo que sugiere una percepción bastante homogénea del desempeño policial a nivel territorial. Sin embargo, se observan ligeras variaciones según la función evaluada: en algunos casos la percepción es marginalmente mayor en zonas urbanas, mientras que en otros ocurre lo contrario. Aunque estas brechas no son amplias, indican que la experiencia con la Policía puede variar sutilmente según el contexto territorial, pero sin generar diferencias estructurales significativas en la percepción general de efectividad.
  ...
  Los resultados evidencian que la mayoría de las respuestas se concentran en tiempos intermedios (entre 30 minutos y 3 horas), lo que sugiere que la percepción general no es de respuesta inmediata. Además, se observan diferencias entre zonas, donde las áreas urbanas tienden a percibir tiempos ligeramente más rápidos que las rurales. 
  
  A nivel regional, existen variaciones importantes: algunas regiones presentan mayores proporciones de respuestas lentas o incluso percepciones de que la Policía “nunca llega”, lo que refleja posibles desigualdades en la cobertura y capacidad de respuesta. En conjunto, estos resultados indican que el tiempo de respuesta es un factor crítico en la percepción de efectividad policial y uno de los principales retos en la evaluación del servicio. En términos generales, el desempeño policial presenta una evaluación heterogénea, con brechas territoriales y desafíos claros en tiempos de respuesta y funciones específicas.
  ...
  El análisis del observatorio evidencia que la confianza en la Policía en Colombia se ubica en un nivel intermedio, lo que refleja una percepción general moderada por parte de la ciudadanía. Si bien no existe un rechazo generalizado hacia la institución, tampoco se observa una confianza consolidada, lo que sugiere un escenario de evaluación cautelosa y condicionada por múltiples factores. Uno de los hallazgos más relevantes es que la confianza no es homogénea, sino que varía significativamente según el territorio y las características sociodemográficas. Las regiones con mayor peso poblacional, como la Andina, tienen un impacto determinante en el promedio nacional, mientras que zonas con menor densidad, aunque presenten mejores niveles de percepción, influyen menos en el resultado agregado. Asimismo, ciudades y regiones con alta concentración poblacional y menores niveles de confianza representan focos críticos que afectan la percepción general del país.

  En términos de legitimidad institucional, los resultados muestran una percepción fragmentada: mientras los comportamientos básicos, como el trato respetuoso, son relativamente bien valorados, existen dudas importantes en aspectos más sensibles como la justicia en el uso de la fuerza y la integridad institucional. La persistencia de percepciones sobre prácticas negativas, aunque en menor proporción, limita la construcción de una legitimidad sólida. Por su parte, la evaluación del desempeño y la efectividad policial presenta variaciones tanto por función como por territorio. Algunas actividades, como el mantenimiento de la seguridad, son mejor percibidas, mientras que otras, como el control del tráfico de drogas, muestran debilidades consistentes en todas las regiones. A nivel territorial, estas diferencias refuerzan la idea de que la efectividad institucional no es uniforme y depende del contexto regional.

  Adicionalmente, el tiempo de respuesta emerge como un factor crítico en la percepción ciudadana. La predominancia de respuestas en rangos intermedios y altos, así como la presencia de percepciones de ineficiencia en ciertas regiones, evidencian desafíos importantes en la capacidad operativa de la institución, especialmente fuera de los centros urbanos. Finalmente, el análisis conjunto de confianza, legitimidad y desempeño demuestra que estas dimensiones están interrelacionadas, pero no son equivalentes. La confianza no depende únicamente de experiencias positivas cotidianas, sino también de la percepción de justicia, efectividad y consistencia institucional. En este sentido, el observatorio cumple su objetivo al evidenciar que la relación entre ciudadanía y Policía es compleja, heterogénea y condicionada por factores territoriales, sociales y operativos, lo que resalta la necesidad de estrategias diferenciadas para fortalecer la confianza institucional en el país. En este contexto, el fortalecimiento de la confianza institucional requiere intervenciones diferenciadas por territorio, mejoras en la capacidad operativa y acciones orientadas a reforzar la legitimidad en dimensiones críticas del ejercicio policial.
